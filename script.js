class Chatbot {
   ...
   isBot ? 'self-start bg-gradient-to-r from-blue-800 to-blue-900 text-gray-100 rounded-br-sm' : 'self-end bg-gradient-to-r from-accent-500 to-accent-600 text-white rounded-bl-sm'
